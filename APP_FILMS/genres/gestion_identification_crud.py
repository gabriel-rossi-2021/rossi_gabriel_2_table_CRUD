...
from APP_FILMS.genres.gestion_identification_wtf_forms import FormWTFDeleteGenre
    ...
    try:
        ...
        if request.method == "POST" and form_delete.validate_on_submit():
            ...
            if form_delete.submit_btn_annuler.data:
                return redirect(url_for("genres_afficher", order_by="ASC", id_identification_sel=0))
